...
-- Generated on 2026-06-24T07:14:55.123Z
-- Table mode: All Tables
...
CREATE TABLE `gamificationspingrants` (
  `user_id` JSON NOT NULL,
  `campaign_id` VARCHAR(24) NOT NULL,
  `granted_by` VARCHAR(24) DEFAULT null,
  `spins_granted` INT DEFAULT 0 NOT NULL,
  `spins_used` INT DEFAULT 0 NOT NULL,
...
ALTER TABLE `gamificationlogs` ADD CONSTRAINT `fk_gamificationlogs_campaign_id` FOREIGN KEY (`campaign_id`) REFERENCES `gamificationcampaigns`(`_id`);
ALTER TABLE `gamificationspingrants` ADD CONSTRAINT `fk_gamificationspingrants_campaign_id` FOREIGN KEY (`campaign_id`) REFERENCES `gamificationcampaigns`(`_id`);
ALTER TABLE `gamificationspingrants` ADD CONSTRAINT `fk_gamificationspingrants_granted_by` FOREIGN KEY (`granted_by`) REFERENCES `users`(`_id`);
...
ALTER TABLE `refreshtokens` ADD CONSTRAINT `fk_refreshtokens_user_id` FOREIGN KEY (`user_id`) REFERENCES `users`(`_id`);
